...
document.addEventListener('DOMContentLoaded', function () {
  ...
  player.init();
  var modulesPlayer = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.module__video .play', '.overlay');
  modulesPlayer.init();
  var difference = new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item');
  difference.init();
  var form = new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('.form', 'http://localhost:3000/requests');
  form.init();
});
...
function () {
  ...
  _createClass(Difference, [{
    ...
    key: "hideItems",
    value: function hideItems(containerItems) {
      containerItems.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
...
/*#__PURE__*/
function () {
  function Form(formSelector, url) {
  ...
  _createClass(Form, [{
    ...
    key: "bindPostData",
    value: function bindPostData(formSelector, url) {
      var _this = this;
      ...
      formSelector.addEventListener('submit', function (e) {
        ...
        _this.postData(url, json).then(function (data) {
          console.log(data);
        }).catch(function () {
          console.log('error');
        }).finally(function () {
    ...
    value: function init() {
      ...
      this.formSelector.forEach(function (item) {
        _this2.bindPostData(item, _this2.url);
      });
    }
  }]);
...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function onPlayerStateChange(state) {
      try {
        var blockedElem = this.activeButton.closest('.module__video-item').nextElementSibling;
        var playButton = this.activeButton.querySelector('svg').cloneNode(true);
...
function (_Slider) {
  ...
  function MiniSlider(container, prev, next, activeClass, animate, autiplay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, prev, next, activeClass, animate, autiplay));
  }
